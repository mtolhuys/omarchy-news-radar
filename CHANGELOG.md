...
- Add the cached-first panel-only Omarchy plugin and local XDG state helper.
- Add an explicit, reversible helper for the audited default Editor shortcut reassignment.
