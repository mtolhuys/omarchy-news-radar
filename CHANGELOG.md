...
- Add the cached-first image-capable Omarchy window and state-v5 local preferences/interests/per-section-filter/name helper with atomic v1/v2/v3/v4 migration; v4 names survive while configurable icons and backgrounds are deliberately retired.
