...
class QmlContractTests(unittest.TestCase):
    ...
    def test_panel_uses_plain_text_and_structural_process_arguments(self) -> None:
        ...
        self.assertIn("Layout.maximumWidth: keySurface.narrow ? card.width * 0.30 : Style.space(176)", qml)
        self.assertIn("Layout.minimumWidth: Style.space(128)", qml)
        self.assertIn("keySurface.narrow ? card.width * 0.72 : card.width * 0.45", qml)
        self.assertIn("Layout.preferredWidth: card.width * 0.36", qml)
