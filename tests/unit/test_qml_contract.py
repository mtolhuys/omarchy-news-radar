...
class QmlContractTests(unittest.TestCase):
    ...
    def test_panel_uses_plain_text_and_structural_process_arguments(self) -> None:
        ...
        self.assertIn("keySurface.narrow ? card.width * 0.22 : (root.readerLayout ? card.width * 0.10 : card.width * 0.12)", qml)
        self.assertIn("Layout.maximumWidth: keySurface.narrow ? card.width * 0.30 : (root.readerLayout ? Style.space(144) : Style.space(160))", qml)
        self.assertIn("Layout.minimumWidth: Style.space(128)", qml)
        self.assertIn("keySurface.narrow ? card.width * 0.72 : (root.readerLayout ? card.width * 0.28 : card.width * 0.38)", qml)
        self.assertIn("root.readerLayout && !keySurface.narrow ? card.width * 0.60 : card.width * 0.44", qml)
