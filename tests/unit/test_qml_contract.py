...
class QmlContractTests(unittest.TestCase):
    ...
    def test_panel_uses_plain_text_and_structural_process_arguments(self) -> None:
        ...
        self.assertIn("root.popupBgIsLight", qml)
        self.assertIn("../assets/io.github.mtolhuys.news-radar-light.svg", qml)
        self.assertIn("../assets/io.github.mtolhuys.news-radar.svg", qml)
        self.assertIn("border.color: Color.popups.border", qml)
        self.assertIn("border.width: Style.spacing.hairline", qml)
        self.assertTrue((ROOT / "assets/io.github.mtolhuys.news-radar-light.svg").is_file())
