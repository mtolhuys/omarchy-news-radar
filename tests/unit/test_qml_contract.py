...
class QmlContractTests(unittest.TestCase):
    ...
    def test_panel_uses_plain_text_and_structural_process_arguments(self) -> None:
        ...
        self.assertIn("keySurface.narrow ? card.width * 0.22 : card.width * 0.10", qml)
        self.assertIn("Layout.maximumWidth: keySurface.narrow ? card.width * 0.30 : Style.space(144)", qml)
        self.assertIn("Layout.minimumWidth: Style.space(128)", qml)
        self.assertIn("keySurface.narrow ? card.width * 0.72 : card.width * 0.28", qml)
        self.assertIn("keySurface.narrow ? card.width * 0.44 : card.width * 0.60", qml)
