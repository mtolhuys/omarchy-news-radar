...
class QmlContractTests(unittest.TestCase):
    ...
    def test_panel_uses_plain_text_and_structural_process_arguments(self) -> None:
        ...
        self.assertIn('String(manifest.__sourceDir) + "/assets/omarchy-logo.svg"', qml)
        self.assertIn('text: "NEWS RADAR"', qml)
        self.assertNotIn('text: "OMARCHY NEWS RADAR"', qml)
        self.assertIn("itemGeometry(narrowMarkAllReadButton", qml)
