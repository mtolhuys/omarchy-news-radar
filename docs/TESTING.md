...
- Saturated-ledger coverage: current-transition marketplace additions displace enough protected release history to remain in the 500-event successor, and the independent publication audit passes that exact candidate instead of freezing Forge.
